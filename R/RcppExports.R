...
#' @export
expected_mc_03_init <- function(x, mu_ilr, sigma_ilr, Z, mu_sampling, sigma_sampling, Hs) {
    .Call('_coda_count_expected_mc_03_init', PACKAGE = 'coda.count', x, mu_ilr, sigma_ilr, Z, mu_sampling, sigma_sampling, Hs)
}
