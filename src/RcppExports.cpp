...
// c_lrnm_fit_maximum_alr_centered
arma::mat c_lrnm_fit_maximum_alr_centered(arma::mat X, arma::vec mu0, arma::mat sigma0, double tol, int em_max_steps, double min_evalue);
RcppExport SEXP _coda_count_c_lrnm_fit_maximum_alr_centered(SEXP XSEXP, SEXP mu0SEXP, SEXP sigma0SEXP, SEXP tolSEXP, SEXP em_max_stepsSEXP, SEXP min_evalueSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type X(XSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type em_max_steps(em_max_stepsSEXP);
    Rcpp::traits::input_parameter< double >::type min_evalue(min_evalueSEXP);
    rcpp_result_gen = Rcpp::wrap(c_lrnm_fit_maximum_alr_centered(X, mu0, sigma0, tol, em_max_steps, min_evalue));
    return rcpp_result_gen;
END_RCPP
}
// mvf_deriv
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_coda_count_c_lrnm_fit_maximum_alr_centered", (DL_FUNC) &_coda_count_c_lrnm_fit_maximum_alr_centered, 6},
