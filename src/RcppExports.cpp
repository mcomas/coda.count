...
// expected_mc_03_init
arma::vec expected_mc_03_init(arma::vec& x, arma::vec& mu_ilr, arma::mat& sigma_ilr, arma::mat& Z, arma::vec& mu_sampling, arma::mat& sigma_sampling, arma::mat& Hs);
RcppExport SEXP _coda_count_expected_mc_03_init(SEXP xSEXP, SEXP mu_ilrSEXP, SEXP sigma_ilrSEXP, SEXP ZSEXP, SEXP mu_samplingSEXP, SEXP sigma_samplingSEXP, SEXP HsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec& >::type x(xSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(expected_mc_03_init(x, mu_ilr, sigma_ilr, Z, mu_sampling, sigma_sampling, Hs));
    return rcpp_result_gen;
END_RCPP
}
// expected_mc_mean
