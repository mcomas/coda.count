...
// [[Rcpp::export]]
List c_cond_lrnm_posterior_moments_hermite(arma::mat& X, arma::vec clr_mu, arma::mat clr_sigma,
                                           arma::mat& C, int order){
  // arma::mat X = M["X"];
...
// [[Rcpp::export]]
List c_cond_lrnm_fit_hermite(arma::mat& X, arma::mat& C, int order,
...
// [[Rcpp::export]]
List c_cond_lrnm_fit_fixed_hermite(arma::mat& X, arma::mat& C, int order,
                                   double em_eps, int em_max_iter){
