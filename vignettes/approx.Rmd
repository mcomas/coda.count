...
```{r}
f_max = pmax(f_prior, f_posterior, f_multinomial, f_multinomial_approx, f_posterior_approx)
x_lim = range(h[f_max>0.01])
y_lim = range(c(f_prior, f_posterior, f_multinomial, f_multinomial_approx, f_posterior_approx))
